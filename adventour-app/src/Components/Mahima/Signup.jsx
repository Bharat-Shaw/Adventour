...
import { Box, Heading, Center, FormControl, Stack, Input, Checkbox, Button, Text, HStack, Flex, Spacer } from '@chakra-ui/react'
      ...
      <Box minH={'100vh'} p='30px 0' bg={theme ? '#101214' : 'gray.100'} >
        <Center>
          <Box borderRadius='20px' bg={theme ? '#191b1d' : 'white'} my='20px' p='30px' color={theme ? 'white' : 'black'}>
            ...
            <Box mt='20px'  mx={'auto'}>
              <Button bg='#4086f3' m={'auto'} width='85%' h='50px' fontSize='18px' color='white' colorScheme='none' onClick={handleGoogleSignIn}>
                <Flex justify={'space-between'} align={'center'}>
                  <Box bg='white' py='8.5px' px='10px' ml='-5px' borderRadius='5px 0 0 5px' ><FcGoogle size='30px' /></Box>
                  <Spacer />
